  ...
  return (
    <main className="min-h-screen text-[#ece7dd]">
      <section className="mx-auto grid min-h-screen w-full max-w-7xl grid-cols-1 gap-8 px-5 py-6 sm:px-8 lg:grid-cols-[280px_1fr] lg:px-10">
        <aside className="border-b border-[#ffffff1a] pb-6 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-8">
          <Link className="flex items-center gap-3" href="/">
            <div className="grid h-11 w-11 place-items-center rounded-lg bg-[#c8a86b] text-lg font-semibold text-[#14110b]">
              W
            </div>
            <div>
              <p className="text-sm font-medium uppercase tracking-[0.18em] text-[#9a9ba2]">
                Wardrobe
              </p>
          ...
          <nav className="mt-10 grid gap-2 text-sm font-medium text-[#9a9ba2]">
            <Link
              className="rounded-lg px-3 py-2 hover:bg-[#ffffff0d] hover:text-[#ece7dd]"
              href="/"
            >
              Overview
            </Link>
            <Link
              className="rounded-lg bg-[#c8a86b] px-3 py-2 font-semibold text-[#14110b]"
              href="/outfits"
            >
              Outfits
            </Link>
          ...
          <div className="mt-10">
            <p className="text-sm font-medium uppercase tracking-[0.16em] text-[#6d6e76]">
              Categories
            </p>
                ...
                <button
                  ...
                  className={
                    ...
                    (selectedCategory === category.name
                      ? "bg-[#12151b]/70 backdrop-blur-xl text-[#ece7dd] shadow-sm ring-1 ring-[#ffffff14]"
                      : "text-[#9a9ba2] hover:bg-[#ffffff0d]")
                  }
                  key={category.name}
                >
                  <span>{category.name}</span>
                  <span className="text-xs text-[#6d6e76]">
                    {category.count}
                  </span>
                </button>
              ))}
        ...
        <div className="space-y-6">
          <header className="flex flex-col justify-between gap-5 border-b border-[#ffffff1a] pb-6 md:flex-row md:items-end">
            <div>
              <p className="text-sm font-medium uppercase tracking-[0.18em] text-[#6d6e76]">
                Outfit builder
              </p>
              <h2 className="mt-2 text-4xl font-semibold leading-tight md:text-5xl">
                Uploaded clothes
              </h2>
              <p className="mt-3 max-w-2xl text-[#9a9ba2]">
                Upload a few garment photos and the app fits them onto a known
                garment template to generate a quick 3D mesh preview.
              </p>
            </div>
            <button
              className="rounded-lg bg-[#c8a86b] px-4 py-3 text-sm font-semibold text-[#14110b] transition hover:bg-[#d8bd82]"
          ...
          {visibleClothes.length === 0 ? (
            <section className="rounded-lg border border-dashed border-[#ffffff14] bg-[#12151b]/70 p-10 text-center shadow-sm">
              <p className="text-sm font-medium uppercase tracking-[0.16em] text-[#6d6e76]">
                Uploaded clothes
              </p>
              <h3 className="mt-2 text-2xl font-semibold text-[#ece7dd]">
                Your library is empty
              </h3>
              <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-[#9a9ba2]">
            ...
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <article
                className={
                  "rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-4 shadow-sm ring-1 ring-[#ffffff14]" +
              ...
              >
                ...
                >
                  {item.imageUrls?.[0] ? (
                    <div className="absolute bottom-4 left-4 rounded-full bg-[#0b0d10]/85 px-3 py-1 text-xs font-semibold text-[#c8a86b]">
                    ...
                    <>
                      ...
                      />
                      <div className="absolute bottom-6 left-8 right-8 h-7 rounded-full bg-[#12151b]/60" />
                    </>
                  )}
                  {item.draftId ? (
                    <button
                      className="absolute right-3 top-3 rounded-full bg-[#0b0d10]/85 px-3 py-1 text-[11px] font-semibold text-[#e0a06d] shadow-sm ring-1 ring-[#ffffff14] transition hover:bg-[#ffffff0d] disabled:cursor-not-allowed disabled:opacity-60"
                ...
                <div className="mt-4 flex items-start justify-between gap-4">
                  <div>
                    <p className="text-xs font-medium uppercase tracking-[0.14em] text-[#6d6e76]">
                      {item.category}
                    </p>
                    <h3 className="mt-1 text-lg font-semibold">{item.name}</h3>
                  </div>
                  <span className="rounded-full bg-[#2a2418] px-3 py-1 text-xs font-semibold text-[#c8a86b]">
                    {item.status}
                  </span>
                </div>
                <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-[#9a9ba2]">
                  <div className="rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-3">
                    <p className="text-xs uppercase tracking-[0.14em] text-[#6d6e76]">
                      Color
                    </p>
                    <p className="mt-1 font-semibold text-[#ece7dd]">
                      {item.color}
                    </p>
                  </div>
                  <div className="rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-3">
                ...
                {item.modelStatus ? (
                  <div className="mt-3 rounded-lg border border-[#ffffff14] bg-[#ffffff08] p-3">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#6d6e76]">
                          Mesh preview
                        </p>
                        <p className="mt-1 text-sm font-semibold text-[#ece7dd]">
                          {item.modelStatus}
                        </p>
                      </div>
                      <button
                        className="rounded-lg bg-[#c8a86b] px-3 py-2 text-xs font-semibold text-[#14110b] transition hover:bg-[#d8bd82]"
                    ...
                    <div className="mt-3 h-2 rounded-full bg-[#ffffff1a]">
                      <div
                        className="h-2 rounded-full bg-[#c8a86b] transition-all"
      ...
      {isUploadOpen ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4">
          <form
            className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-5 shadow-2xl"
            onSubmit={handleGenerateModel}
          >
            <div className="flex items-start justify-between gap-4 border-b border-[#ffffff1a] pb-4">
              <div>
                <p className="text-sm font-medium uppercase tracking-[0.18em] text-[#6d6e76]">
                  New garment
                </p>
              ...
              <button
                className="rounded-lg border border-[#ffffff14] px-3 py-2 text-sm font-semibold hover:bg-[#ffffff0d] disabled:cursor-not-allowed disabled:opacity-60"
            ...
            <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_280px]">
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-[#ffffff14] bg-[#12151b]/70 backdrop-blur-xl p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-base font-semibold text-[#ece7dd]">
                        Upload garment photos
                      </p>
                      <p className="mt-1 text-sm text-[#9a9ba2]">
                        Front and back are required — depth is reconstructed automatically.
                      </p>
                    </div>
                    <div className="rounded-full bg-[#12151b]/70 backdrop-blur-xl px-3 py-1 text-xs font-semibold text-[#9a9ba2]">
                      Required: Front + Back
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    {uploadRoles.map((role) => {
                      ...
                      return (
                        <div
                          className="rounded-lg border border-dashed border-[#ffffff26] bg-[#ffffff08] p-3"
                          key={role}
                        >
                          <div className="flex items-center justify-between gap-3">
                            <p className="text-sm font-semibold text-[#ece7dd]">
                              {garmentPhotoLabel(role)}
                            </p>
                            <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#6d6e76]">
                              {isRequired ? "Required" : "Optional"}
                            </span>
                          </div>

                          <label className="mt-3 grid min-h-40 cursor-pointer place-items-center overflow-hidden rounded-lg border border-dashed border-[#ffffff26] bg-[#12151b]/70 backdrop-blur-xl text-center transition hover:border-[#c8a86b]">
                            {photo ? (
                              <div
                                className="relative h-full min-h-40 w-full bg-[#ffffff0d]"
                                style={{
                              ...
                              <div className="px-4">
                                ...
                                <p className="mt-1 text-xs leading-5 text-[#6d6e76]">
                                  {role === "front"
                          ...
                          <div className="mt-3 flex items-center justify-between gap-3">
                            <p className="truncate text-xs text-[#9a9ba2]">
                              {photo ? photo.name : "No file selected"}
                            </p>
                            {photo ? (
                              <button
                                className="rounded-lg border border-[#ffffff14] px-2 py-1 text-xs font-semibold text-[#9a9ba2] transition hover:bg-[#ffffff0d]"
                ...
                {orderedUploadPhotos.length > 0 ? (
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                    {orderedUploadPhotos.map((photo) => (
                      <div
                        className="relative h-32 overflow-hidden rounded-lg bg-[#ffffff0d]"
                        key={photo.role}
                        style={{
                          backgroundImage: "url(" + photo.url + ")",
                          backgroundPosition: "center",
                      ...
                      >
                        <span className="absolute bottom-2 left-2 rounded-full bg-[#0b0d10]/85 px-2 py-1 text-[11px] font-semibold text-[#9a9ba2]">
                ...
                {uploadError ? (
                  <p className="rounded-lg border border-[#7a4632] bg-[#241713] px-3 py-2 text-sm font-semibold text-[#e0a06d]">
                    {uploadError}
                  </p>
                ) : null}
              </div>

              <aside className="rounded-lg border border-[#ffffff14] bg-[#12151b]/70 backdrop-blur-xl p-4">
                <p className="text-sm font-medium uppercase tracking-[0.16em] text-[#6d6e76]">
                  Mesh build
                </p>
                      ...
                      <span
                        className={
                          ...
                          (hasRequiredUploadPhotos
                            ...
                            : "bg-[#ffffff1a] text-[#9a9ba2]")
                        }
                      >
                        {index + 1}
                      </span>
                      <span className="text-sm font-semibold text-[#ece7dd]">
                        {stage}
                      </span>
                    </div>
                  ))}
                ...
                <div className="mt-6 rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-4">
                  <div className="mx-auto h-28 w-24 rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-3 shadow-sm">
                  ...
                  <p className="mt-3 text-center text-sm font-semibold text-[#9a9ba2]">
                    Standard mesh first
                  </p>
                  <p className="mt-2 text-center text-xs leading-5 text-[#6d6e76]">
            ...
            <div className="mt-5 flex flex-col-reverse justify-end gap-3 border-t border-[#ffffff1a] pt-4 sm:flex-row">
              <button
                className="rounded-lg border border-[#ffffff14] px-4 py-3 text-sm font-semibold hover:bg-[#ffffff0d] disabled:cursor-not-allowed disabled:opacity-60"
                disabled={isSubmitting}
                onClick={closeUploadPrompt}
                type="button"
              >
              ...
              <button
                className="rounded-lg bg-[#c8a86b] px-4 py-3 text-sm font-semibold text-[#14110b] transition hover:bg-[#d8bd82] disabled:cursor-not-allowed disabled:bg-[#33383e]"
      ...
      {selectedDraftItem ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4">
          <div className="max-h-[92vh] w-full max-w-5xl overflow-y-auto rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-5 shadow-2xl">
            <div className="flex items-start justify-between gap-4 border-b border-[#ffffff1a] pb-4">
              <div>
                <p className="text-sm font-medium uppercase tracking-[0.18em] text-[#6d6e76]">
                  3D garment mesh
              ...
              <button
                className="rounded-lg border border-[#ffffff14] px-3 py-2 text-sm font-semibold hover:bg-[#ffffff0d]"
            ...
            <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_320px]">
              <div className="rounded-lg bg-[#ffffff08] p-6">
                {selectedDraftItem.mesh ? (
                  <GarmentMeshViewer
                    className="min-h-[560px] overflow-hidden rounded-lg border border-[#ffffff14]"
                    background="#0b0d10"
                    key={
                  ...
                  <div className="grid min-h-[560px] place-items-center rounded-lg border border-[#ffffff14] bg-[#12151b]/70 backdrop-blur-xl p-4 text-sm font-semibold text-[#9a9ba2]">
                    Building the mesh...
                  </div>
                )}

                <div className="mt-4 flex flex-wrap items-center justify-between gap-3 text-sm text-[#9a9ba2]">
                  <div>
                    Drag to orbit the 3D mesh. Scroll to zoom. The view now auto-fits on open.
                  </div>
                  <div className="rounded-full bg-[#12151b]/70 backdrop-blur-xl px-3 py-1 font-semibold text-[#c8a86b] shadow-sm ring-1 ring-[#ffffff14]">
                ...
                <p className="mt-3 text-sm leading-6 text-[#9a9ba2]">
                ...
                {selectedDraftItem.mesh ? (
                  <div className="mt-4 grid gap-3 rounded-lg bg-[#12151b]/70 backdrop-blur-xl p-4 text-sm text-[#9a9ba2] ring-1 ring-[#ffffff14] sm:grid-cols-4">
                    <div>
                      <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#6d6e76]">
                        Shape base
                      </p>
                      <p className="mt-1 font-semibold text-[#ece7dd]">
              ...
              <aside className="rounded-lg border border-[#ffffff14] bg-[#12151b]/70 backdrop-blur-xl p-4">
                ...
                <p className="mt-2 text-xs leading-5 text-[#9a9ba2]">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  {selectedDraftItem.imageUrls?.map((url, index) => (
                    <button
                      className={
                        "relative h-28 overflow-hidden rounded-lg bg-[#ffffff0d] text-left ring-2 transition " +
                        (selectedReferenceIndex === index
                          ? "ring-[#c8a86b]"
                          : "ring-transparent hover:ring-[#ffffff26]")
                      }
